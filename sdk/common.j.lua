...
-- Buff
BUFF_SF_ICON_NORMAL = ConvertBuffStringField(FourCC('fart'--[[1717662324--]])) ---@type buffstringfield
BUFF_SF_TOOLTIP_NORMAL = ConvertBuffStringField(FourCC('ftip'--[[1718905200--]])) ---@type buffstringfield
...
---@param whichImage image
---@return location
function GetImagePositionLocation (whichImage) end
---@param whichImage image
---@param whichLocation location
